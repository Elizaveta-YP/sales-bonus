...
//     //определила новые переменные
//     const calculateRevenue = calculateSimpleRevenue();
//     const calculateBonus = calculateBonusByProfit();

//     const { calculateRevenue, calculateBonus } = options;

//     //определяю что переменные это функции
//     if (!option 
//         || typeof option.calculateRevenue !== 'function'
//         || typeof option.calculateBonus !== 'function'
//     ) {
...
//     const sellerIndex = { Object.fromEntries(someArr.map(item => [item.ID, item]));} // Ключом будет id, значением — запись из sellerStats
